            ...
            <div>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  { icon: Users,   label: '联系方式', value: '扫描下方二维码添加客服微信' },
              ...
              <div className="mt-8 flex items-center gap-6">
                <div className="w-36 h-36 rounded-2xl overflow-hidden border border-sand-200 shadow-sm shrink-0 bg-white">
                  ...
                  <img src="/service-qr.jpg" alt="客服二维码" className="w-full h-full object-contain" />
                </div>
                <div>
                  <p className="text-sm font-medium text-charcoal mb-1">扫码添加客服微信</p>
                  <p className="text-xs text-charcoal-light leading-relaxed">随时咨询预约事项<br />我们会尽快回复你</p>
                </div>
              </div>
